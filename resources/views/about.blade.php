    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div class="bg-white p-5 rounded-2xl border border-gray-200/80 shadow-xs">
                    <div
                        class="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center font-bold text-sm mb-3">
                        VNC
                    </div>
                ...
                <div class="bg-white p-5 rounded-2xl border border-gray-200/80 shadow-xs">
                    <div
                        class="w-10 h-10 rounded-xl bg-cyan-50 text-cyan-600 flex items-center justify-center font-bold text-sm mb-3">
                        🐳
                    </div>
