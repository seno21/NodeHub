<div class="space-y-6">
    ...
    <div class="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-6">
        <div class="flex items-center gap-3 pb-4 border-b border-slate-100">
            <span
                class="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-50 text-blue-600 font-bold border border-blue-100/80 shrink-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <x-input-error :messages="$errors->get('ip_address')" class="mt-2 text-xs" />
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <x-input-error :messages="$errors->get('os_type')" class="mt-2 text-xs" />
            </div>
                    ...
                    @foreach ($tagsList as $tagItem)
                        <label
                            ...
                            <input type="checkbox" name="tag_ids[]" value="{{ $tagItem->id }}"
                                @checked(in_array($tagItem->id, $selectedTagIds))
    ...
    <div class="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-5">
        <div class="flex items-center justify-between border-b border-slate-100 pb-4">
            <div class="flex items-center gap-3">
                <span
                    class="flex h-10 w-10 items-center justify-center rounded-xl bg-teal-50 text-teal-700 font-bold border border-teal-100/80 shrink-0">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                ...
                <x-input-error :messages="$errors->get('vnc_port')" class="mt-2 text-xs" />
            </div>
    ...
    <div class="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-5">
        <div class="flex items-center justify-between border-b border-slate-100 pb-4 flex-wrap gap-2">
            <div class="flex items-center gap-3">
                <span
                    class="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-900 text-white font-bold shadow-xs shrink-0">
        ...
        <div class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    <x-input-error :messages="$errors->get('ssh_user')" class="mt-2 text-xs" />
                </div>
                ...
                <div>
                    ...
                    <x-input-error :messages="$errors->get('ssh_port')" class="mt-2 text-xs" />
                </div>
            </div>
            ...
            <div>
                ...
                @else
                    <div
                        class="mt-3 p-3.5 rounded-xl bg-gradient-to-r from-amber-500/10 via-amber-50 to-amber-100/50 border border-amber-300/60 text-amber-900 shadow-xs flex items-start gap-3">
                        <div
                ...
                @endif
                <x-input-error :messages="$errors->get('ssh_password')" class="mt-2 text-xs" />
            </div>
        </div>
    </div>
