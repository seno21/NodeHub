        ...
        <form x-on:submit.prevent="submitFastConnect()" class="mt-5 space-y-4">
            ...
            <div class="pt-2 border-t border-slate-100">
                <label class="flex items-center gap-2.5 cursor-pointer select-none">
                    ...
                    <span class="text-xs font-semibold text-slate-700">Save to Device List</span>
                </label>
                ...
                <div x-show="form.save_device" x-transition.opacity class="mt-3">
                    ...
                    <input type="text" x-model="form.device_name" placeholder="e.g. Cashier PC / Display 1"
                ...
                try {
                    ...
                    if (response.ok && data.redirect) {
                        ...
                        this.errorMessage = data.message ||
                            'Failed to open VNC connection. Please check IP address and port.';
                    }
                } catch (error) {
                    this.errorMessage = 'Network error while connecting to VNC target.';
                } finally {
                    this.isConnecting = false;
                }
            }
